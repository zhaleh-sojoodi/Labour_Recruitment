...
namespace roleDemo {
    public class Startup {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env) {
            ...
            RecurringJob.AddOrUpdate<ScheduleRepo>("weekly-check-avalability", x => x.CheckIsAvailable(), "*/10 * * * *");
            RecurringJob.AddOrUpdate<ScheduleRepo>("weekly-schedule", x => x.AddWeeklySchedule(), "*/2  * * * *");
        }
