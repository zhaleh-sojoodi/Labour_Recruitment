...
{
    public partial class LabourerRecruitmentContext : DbContext
    {
        public LabourerRecruitmentContext()
        {
        }

        public LabourerRecruitmentContext(DbContextOptions<LabourerRecruitmentContext> options)
            : base(options)
        {
        }
